...
if (times7):
	if (corr==0):
		np.savetxt('HOD2_x7.params',out,fmt='%.2f %.6f %e %e')
	else:
		np.savetxt('HOD2_corr_x7.params',out,fmt='%.2f %.6f %e %e')
else:
	if (corr==0):
		np.savetxt('HOD2.params',out,fmt='%.2f %.6f %e %e')
	else:
		np.savetxt('HOD2_corr.params',out,fmt='%.2f %.6f %e %e')
