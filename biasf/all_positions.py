...
X,Y,Z,M,ID = np.loadtxt('../../DESI_outputs/UNIT_001/halos_UNIT_001/out_100p_X_Y_Z_VX_VY_VZ_M.txt',usecols = (0,1,2,6,7),unpack = True) # El catalogo debe tener datos de X, Y, Z. Velocidades no es necesario al trabajar en real space
...
for i in range(0,len(edges)-1):
    ...
    nombre = str(i) + ".txt"
    np.savetxt('../../DESI_outputs/positions_for_each_mass_bin_snap100_21particles/' + nombre,pos)
